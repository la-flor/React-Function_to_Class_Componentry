...
class JokeList extends React.Component {
  ...
  /* get jokes from API if there are no jokes */
...
// new prefered functional component design commented out below
...
//   function generateNewJokes = this.generateNewJokes.bind(this);
// this.() {
//     setJokes([]);
//   }
...
//     return (
//       <div className="JokeList">
//         <button className="JokeList-getmore" onClick={generateNewJokes = this.generateNewJokes.bind(this);
// this.}>
//           Get New Jokes
//         </button>
